...
import com.example.myapplication.Util.IconUtil;
                ...
                new Thread(new Runnable(){
                    ...
                    public void run() {
                        try{
                            ...
                            if(isSpecialChar(password)==true){
                                flag1 =1;
...
//                            }
                                if (password.equals(pwdAgain) == true) {
                                    ...
                                    user.setIconFile_User(IconUtil.icon);
...
//
                                ...
                                Looper.prepare();
                                Toast.makeText(SignActivity.this, "密码输入不符合", Toast.LENGTH_SHORT).show();
                                Looper.loop();
                            }
