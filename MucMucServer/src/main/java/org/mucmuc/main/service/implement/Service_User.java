...
public class Service_User implements Interface_User_service {
    ...
    public ResultEntity login(User user) {
        ...
        catch(Exception e)
        {
            ...
            resultEntity.setInfo_error("登录失败; 捕获到异常");
            return resultEntity;
        }
    ...
    public ResultEntity register(User user) {
        ...
        catch(Exception e)
        {
            e.printStackTrace();
            resultEntity.setState(false);
            resultEntity.setInfo_error("注册失败; 捕获到异常");
            return resultEntity;
        }
    ...
    public ResultEntity get(User user) {
        ...
        catch(Exception e)
        {
            e.printStackTrace();
            resultEntity.setState(false);
            resultEntity.setInfo_error("获取用户信息失败; 捕获到异常");
            return resultEntity;
        }
    }
    ...
    public ResultEntity search(User user) {
        ...
        catch(Exception e)
        {
            e.printStackTrace();
            resultEntity.setState(false);
            resultEntity.setInfo_error("模糊搜索失败; 捕获到异常");
            return resultEntity;
        }
    }
    ...
    public ResultEntity delete(User user0,User user1) {
        ...
        catch(Exception e)
        {
            e.printStackTrace();
            resultEntity.setState(false);
            resultEntity.setInfo_error("删除用户失败; 捕获到异常");
            return resultEntity;
        }
    }
}
